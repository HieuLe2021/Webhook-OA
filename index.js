...
app.post('/webhook', async (req, res) => {
    ...
    try {
        // Gửi dữ liệu đến Power Automate (giữ nguyên logic cũ)
        // endpoint 2
        const response = await axios.post('https://prod-61.southeastasia.logic.azure.com:443/workflows/7163b36bea4d4134b6cc64ab8e2bde0c/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=z1CtOtPThz5AZx0yPNdjnjimtTIFC10DpSSvBHpjN9U', data, {
            headers: {
                'Content-Type': 'application/json',
            },
        });
...
app.post('/webhook', async (req, res) => {
    ...
    try {
        // Gửi dữ liệu đến Power Automate (giữ nguyên logic cũ)
        // endpoint 3
        const response = await axios.post('https://prod-05.southeastasia.logic.azure.com:443/workflows/1069888b89b04e318a8c1fdab918d057/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=XD2H1mbzby0LHOV7CmCrofysEhc1jB1WYbSSTcSXS84', data, {
            headers: {
                'Content-Type': 'application/json',
            },
        });
